...
const Navbar = () => {
  return (
    <div>
      <nav className="w-full fixed px-3 py-3 flex justify-between items-center bg-white shadow-lg top-0">
        ...
        <a className="hidden lg:inline-block py-2 px-6 bg-blue-500 hover:bg-blue-600 text-sm text-white rounded-xl transition duration-200 mr-20" href="#">Login / Registration</a>
      </nav>
